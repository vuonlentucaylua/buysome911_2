...
if ( isset( $thm_options['deep_menu_link_color'] ) && $thm_options['deep_menu_link_color']['regular'] ) {
	echo "#wrap .nav a { .color:{$thm_options['deep_menu_link_color']['regular']};}\n\n";
}

if ( isset( $thm_options['deep_menu_link_color'] ) && $thm_options['deep_menu_link_color']['hover'] ) {
	echo "#wrap .nav a:hover,.transparent-header-w.t-dark-w #header.horizontal-w.duplex-hd .nav > li:hover > a,
    .transparent-header-w #header.horizontal-w .nav > li:hover > a {color:{$thm_options['deep_menu_link_color']['hover']};}\n\n";
}

if ( isset( $thm_options['deep_menu_link_color'] ) && $thm_options['deep_menu_link_color']['active'] ) {
	echo "#wrap .nav li.current > a, #wrap .nav li.current ul li a:hover, #wrap .nav li.active > a {color:{$thm_options['deep_menu_link_color']['active']};}\n\n";
}
