...
*
* Skin Name: portfolio-hover-3
* Skin Slug: portfolio-hover-3
...
$output = null;
	...
	$output .= $tg_el->get_media();
		...
		$output .= $tg_el->get_center_wrapper_start();
			...
			$output .= $tg_el->get_icon_element(array('icon' => 'tg-icon-arrows-out', 'action' => array('type' => 'lightbox')), 'tg-element-3 colorr');
			$output .= $tg_el->get_icon_element(array('icon' => 'tg-icon-arrow-next-thin', 'action' => array('type' => 'link', 'link_target' => '_self', 'link_url' => 'post_url', 'custom_url' => '', 'meta_data_url' => '')), 'tg-element-4 colorr');
		$output .= $tg_el->get_center_wrapper_end();
		// Center wrapper end

		// Bottom wrapper start
		$output .= '<div class="tg-bottom-holder">';
			$output .= $tg_el->get_the_terms(array('taxonomy' => '', 'link' => true, 'color' => 'background', 'separator' => ', ', 'override' => true), 'tg-element-5  colorb');
		$output .= '</div>';
		// Bottom wrapper end
