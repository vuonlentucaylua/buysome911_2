	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		...
		public function initSettings() {
			...
			if ( isset( $this->active_import_id ) && !empty( $this->active_import_id ) ) {
				...
				$this->pages  	   			= (bool) $this->parent->pages;
				$this->posts  	   			= (bool) $this->parent->posts;
				$this->contact_forms  	   	= (bool) $this->parent->contact_forms;
				$this->portfolios  	   		= (bool) $this->parent->portfolios;
				$this->fetch_attachments    = (bool) $this->parent->fetch_attachments;
				$this->import_sliders       = (bool) $this->parent->import_sliders;
				$this->import_theme_opts    = (bool) $this->parent->import_theme_opts;
				$this->import_widgets       = (bool) $this->parent->import_widgets;
