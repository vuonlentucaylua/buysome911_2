jQuery(function($) {
    $(document).ready(function() {
        ...
        $(".redux_field_search").keypress(function (evt) {
            ...
            // console.log( $( '.redux_field_search' ).attr('value') );
        });
        ...
        jQuery('.redux_field_search').typeWatch({
            callback:function( searchString ){
                ...
                if (searchString != "") {
                    ...
                    parent.find('.redux-section-field, .redux-info-field, .redux-notice-field, .redux-container-group, .redux-section-desc, .redux-group-tab h3, .redux-group-tab h2').show();
                }            
