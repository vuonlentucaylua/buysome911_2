<?php
if ( is_plugin_active( 'buddypress/bp-loader.php' ) && function_exists( 'deep_bp_user_notifications' ) ) { ?>

	<!-- modal text edit -->
	<div class="whb-modal-wrap whb-modal-edit" data-element-target="bp-notification">
